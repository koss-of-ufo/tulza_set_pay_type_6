...
export function getDom() {
  return {
    ...
    uuidSqlOutput: document.getElementById('uuidSqlOutput'),
    uuidCsvOutput: document.getElementById('uuidCsvOutput'),
    cardUuidMain: document.getElementById('cardUuidMain'),
    cardUuidSql: document.getElementById('cardUuidSql'),
    cardUuidCsv: document.getElementById('cardUuidCsv'),
    uuidMainCount: document.getElementById('uuidMainCount'),
    uuidSqlCount: document.getElementById('uuidSqlCount'),
    uuidCsvCount: document.getElementById('uuidCsvCount'),
